...
using CargoCoordinationPlatform.Domain.Constants;
...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("CargoCoordinationPlatformDb");
        Guard.Against.Null(connectionString, message: "Connection string 'CargoCoordinationPlatformDb' not found.");
